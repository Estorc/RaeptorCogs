...
template<typename T>
VkDeviceMemory AllocateMemory(RaeptorCogs::GAPI::Vulkan::RendererBackend*, T, VkMemoryPropertyFlags) {
    static_assert(sizeof(T) == 0, "AllocateMemory not specialized for this type");
    return VK_NULL_HANDLE;
}

template<>
VkDeviceMemory AllocateMemory<VkMemoryRequirements>(RaeptorCogs::GAPI::Vulkan::RendererBackend* renderer, VkMemoryRequirements memRequirements, VkMemoryPropertyFlags properties) {
...
template<>
VkDeviceMemory AllocateMemory<VkImage>(RaeptorCogs::GAPI::Vulkan::RendererBackend* renderer, VkImage image, VkMemoryPropertyFlags properties) {
...
template<>
VkDeviceMemory AllocateMemory<VkBuffer>(RaeptorCogs::GAPI::Vulkan::RendererBackend* renderer, VkBuffer buffer, VkMemoryPropertyFlags properties) {
    VkMemoryRequirements memRequirements;
