...
#ifdef __EMSCRIPTEN__
EM_JS(double, _GetScreenWidthJS, (), { return window.innerWidth; });

// JavaScript function to get window height
EM_JS(double, _GetScreenHeightJS, (), { return window.innerHeight; });
#endif
...
void StartLoop(std::function<void(Window &)> updateFunction, Window &window) {
  glfwSetScrollCallback(
      window.getGLFWWindow(), [](GLFWwindow *, double xoffset, double yoffset) {
